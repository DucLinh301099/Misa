<!-- src/components/ControlComponent/ExpenseAccountInput.vue -->
<template>
  <div class="expense-account-input-wrapper">
    <label for="expense-account-input">Tài khoản chi</label>
    ...
    <Modal :visible="isModalVisible" @close="isModalVisible = false">
      <CreateBankAccount @close="isModalVisible = false" />
    </Modal>
  </div>
</template>
